...
2. doc/secagent/upgrades/2026-09-12-self-learning-design.md（全文；重点 §4 从资料和实战偏差学成漏洞规程、§6.1 新 revision 状态机、§6.3 最小接口增量、§11 的 L2 行）
3. doc/secagent/upgrades/2026-09-12-self-learning-design.md §11.1/§11.2（L0/L1 已实施记录——本次在前置已完成的前提下开工）
4. 受影响域契约：doc/secagent/v5/07-know.md、11-ledger.md、10-exec.md、02-vuln.md、15-eval.md
