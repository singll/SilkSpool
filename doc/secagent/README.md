...
doc/secagent/
  ...
  19-ui-unify.md                        在办专项（临时；验收后回填 16-dashboard/主题并归档）
...
模块索引：00 契约宪法 · 01 总线 · 02 漏洞 · 03 资产 · 04 接口 · 05 任务 · 06 事实 · 07 知识 · 08 授权 · 09 审批 · 10 执行 · 11 台账 · 12 报告 · 13 代理 · 14 FGS · 15 评测 · 16 看板与 UI 原生面 · 17 LLM 工具面 · 18 迁移 · 19 看板 UI 全局统一重构（在办专项，验收后回填 16 并归档）。
（原 19-ui-surface 已并入 16；现 19 号为 [19-ui-unify.md](19-ui-unify.md) 复用——UI 视觉/交互统一专项设计，非常驻模块契约。）

## 文档治理规则

### A. 目录整洁：正式文档 vs 临时文档

1. **根目录只放正式常驻文档**：`doc/secagent/` 根下只允许 `00–18` 正式模块契约、`PROGRESS.md`、`README.md`，以及**明确在办**的专项文档（如 [19-ui-unify.md](19-ui-unify.md)）。
