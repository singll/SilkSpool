...
补充证据见 [csai 升级预检](archive/upgrades/2026-09-12-dsh-0.1.5-rc.2-record.md)：当前 `llm_probe=true` 尚未实际调用模型，不能由 Mode A 的 7/7 推定模型恢复率或漏洞探测能力；修复与验收设计见 [自学习专项](archive/upgrades/2026-09-12-self-learning-design.md)。
