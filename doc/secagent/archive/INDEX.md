...
> 当前入口：[文档导航](../README.md) · [v5 架构](v5-README.md) · [当前进度](../PROGRESS.md) · [进度历史归档](progress-history.md)。
...
| 归档文件 | 原角色 |
|---|---|
| [进度历史归档](progress-history.md) | PROGRESS.md 瘦身前内容：历次更新日志、已完成节点（附 commit）、已关账待办、文档漂移排查 B1–B5 及批次守则（2026-09-19 归档） |
| [README](README.md) | v4.x 持续推进文档快照（状态/待人工/待办/工作规范/里程碑，归档时点 v4.7） |
| [系统全景](silksecagent-system-complete.md) | v4.x 系统解剖（v1.3） |
| [早期 v5 总体方案](silksecagent-v5-domain-plugin-architecture.md) | 2026-09-06 起草，已由 v5/00–18 取代 |
| [P11 主计划](dsh-secagent-plan-v6.md) | 历史快照 |
| [体系评估](silksecagent-assessment-2026-08-28.md) | 2026-08-28 快照 |
