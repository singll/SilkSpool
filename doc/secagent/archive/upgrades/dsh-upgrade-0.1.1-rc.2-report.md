...
> 当前架构见 [v5](../../README.md)，历次升级见 [时间线](README.md)。旧回滚操作有版本前提，Session V3 会话升级以 [0.1.5-rc.2 方案](2026-09-12-dsh-0.1.5-rc.2-plan.md) 为准。
...
> 关联文档：[dsh-secagent-plan-v6.md](../dsh-secagent-plan-v6.md)（历史主计划）
