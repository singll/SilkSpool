...
1. `doc/secagent/archive/upgrades/2026-09-12-dsh-0.1.5-rc.2-record.md` §13.4（U2 完成证据）
2. `doc/secagent/archive/upgrades/2026-09-12-dsh-0.1.5-rc.2-plan.md` §5.3（生产切换顺序）
3. 本文件（完整上下文）
...
将以下文件从 csai 复制到本地 `doc/secagent/archive/upgrades/` 或通过 SHA 验证：
...
成功后，向 `doc/secagent/archive/upgrades/2026-09-12-dsh-0.1.5-rc.2-record.md` 追加 **§14**：
...
将此 prompt 保存到 `doc/secagent/archive/upgrades/HANDOFF-<phase>-<date>.md`，供下一个会话直接使用。
