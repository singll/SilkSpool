...
这是对 [07-know](../../07-know.md) 现有 model 许可和晋升语义的**明确变更提议**。实施时升级契约版本、错误 hint、调用示例与兼容投影，并测试每个入口；只新增一套 candidate 表而保留旧直升入口不能算完成。
...
L5 四项交付全部上线（契约：know 60→70 全绿，本地 14 域全套 395/395 全绿 + csai setup 内双跑同绿 + 生产冒烟；契约见 [07-know.md](../../07-know.md) §十一，[11-ledger.md](../../11-ledger.md) §七备案）：
...
L6 六项交付全部上线（契约：know 70→73、task 30→38、exec 23→24、eval 28→29、scope 15/15，本地 15 套件全套全绿 + csai setup 内硬门槛同绿 + 生产冒烟；契约见 [07-know.md](../../07-know.md) §十二、[05-task.md](../../05-task.md)、[15-eval.md](../../15-eval.md) §2.3、[16-dashboard.md](../../16-dashboard.md)、[10-exec.md](../../10-exec.md)）：
...
- v5：[全局约定](../../00-conventions.md)、[task](../../05-task.md)、[fact](../../06-fact.md)、[know](../../07-know.md)、[approval](../../09-approval.md)、[exec](../../10-exec.md)、[ledger](../../11-ledger.md)、[FGS](../../14-fgs.md)、[eval](../../15-eval.md)、[dashboard](../../16-dashboard.md)。
