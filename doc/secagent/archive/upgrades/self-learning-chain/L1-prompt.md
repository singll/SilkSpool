...
2. doc/secagent/archive/upgrades/2026-09-12-self-learning-design.md（全文；重点 §3 执行学习记录、§3.3 证据发布与保留、§11 的 L1 行）
3. doc/secagent/archive/upgrades/2026-09-12-self-learning-design.md §11.1（L0 已实施记录——本次在前置已完成的前提下开工）
4. 受影响域契约：doc/secagent/10-exec.md、07-know.md、11-ledger.md、14-fgs.md、02-vuln.md
