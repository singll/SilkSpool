...
> 正文保留历史结论；2026-09-12 仅调整资料迁移后的导航链接。
...
*证据快照：本报告 §0 表格中全部数字取自 2026-08-28 spool exec csai 实测；历史对比基线取自[当时的持续推进文档](README.md)与[0.1.1-rc.2 升级报告](../upgrades/dsh-upgrade-0.1.1-rc.2-report.md)的 08-22/08-23 记录。*
