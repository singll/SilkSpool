...
2026-09-16 核查：生产已切 DSH 0.1.5-rc.2（U4 观察期至 09-18，未关账）。**自学习 L0 已实施上线**（K1–K4/K6：kb 缺列与内容复验闭环、task 守卫异常显式失败、订阅 partial 可见、llm_probe 标签纠正、eval-run.js 迁 v5 总线；契约 bus/know/task/eval 126/126 全绿，生产冒烟通过）；L1–L6 未执行。5.2 别名闸口已顺延至 2026-09-22T15:07:10+08:00（详见 PROGRESS §一）。
