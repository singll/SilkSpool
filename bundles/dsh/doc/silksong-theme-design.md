...
## 十一、v4.2 增补：UI 原生面集成（2026-09-18，16-dashboard §四）

> **零新色值**。新表面全部消费既有 `--dsw-alias-*`；chrome（槽位框架、tab 条、设置页骨架、右侧栏分栏/浮窗）由宿主渲染 = 自动吃 silksong 令牌，零额外主题工作。以下七条与 16-dashboard P0–P6 实现一一对应。
