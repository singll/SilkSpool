...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var TOKENS = {
      ...
      '--dsw-alias-border-l2-darkmode-thin': '#333B42',
      '--dsw-alias-border-l3': '#51616D',
      '--dsw-alias-border-l4': '#5E6E7A',
      '--dsw-alias-border-inverted': 'rgba(239,234,224,0.08)',
      ...
      '--dsw-alias-interactive-bg-active': 'rgba(239,234,224,0.12)',
