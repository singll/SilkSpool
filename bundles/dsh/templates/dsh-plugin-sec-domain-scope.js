...
export const SCOPE_MANIFEST = {
  ...
  commands: {
    scope_grant: {
      ...
      idempotent: 'auto',
      idempotent_fields: ['program_name', 'entries', 'platform', 'finding_db', 'max_risk', 'fixed_egress_ip'],
    ...
    scope_revoke: {
      ...
      idempotent: 'auto',
      idempotent_fields: ['program_name', 'entries'],
    ...
    program_bind_workspace: {
      ...
      idempotent: 'auto',
      idempotent_fields: ['program_name', 'workspace'],
      events: ['program.bound'],
      event_limit: 1,
    ...
    program_archive: {
      ...
      idempotent: 'auto',
      idempotent_fields: ['program_name'],
      events: [],
      event_limit: 1,
  ...
  events: {
    ...
    'program.bound': { payload: { type: 'object' }, redact: [] },
  },
  subscribes: {},
  ...
  const commands = {
    ...
    program_bind_workspace: async (args, repo) => {
      ...
      return {
        ...
        events: [{ name: 'program.bound', payload: { program_name: args.program_name, workspace_id: workspaceId, workspace_path: workspacePath, unbound: workspaceId === null } }],
