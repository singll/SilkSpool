...
assemble() {
    ...
    cp "$BASE_DIR/dsh-plugin-sec-suite.native-guard.js" "$PLUGIN_DIR/native-guard.js"
    cp "$BASE_DIR/dsh-plugin-sec-suite.worker-runtime.js" "$PLUGIN_DIR/worker-runtime.js"
    ...
    cat > "$PLUGIN_DIR/package.json" <<'EOF'
{
  ...
  "files": ["index.js", "asset-db.js", "asset-graph.js", "experience.js", "parsers.js", "webhook.js", "scheduler.js", "task-policy.js", "parse-proposal.js", "host-compat.js", "native-guard.js", "worker-runtime.js", "persona.py", "dashboard-rpc.js", "cordis.patch.yml"],
  "license": "MIT",
