...
- 两个上下文共享 `docs/adr/`（系统级架构决策）；SilkSecAgent 的[领域语言](bundles/dsh/CONTEXT.md)与[文档入口](doc/secagent/README.md)分工维护：当前设计契约在 `doc/secagent/00–19`，进度与更新在唯一的 [PROGRESS](doc/secagent/PROGRESS.md)，历史与历次升级在 [archive](doc/secagent/archive/)。
